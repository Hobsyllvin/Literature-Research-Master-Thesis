\begin{tikzpicture}[scale=4]
    ...
    % Draw axes
    \draw[thick,<->] (0,2) -- (4,2) node[anchor=north west] {Haptic Fidelity};
    \draw[thick,<->] (2,0) -- (2,4) node[anchor=south east] {Versatility};
    ...
    \node[anchor=west] at (0.25, 3.65) {Quality q > 0.9};

    \node[circle, fill=c2, inner sep=2pt] at (0.22, 3.55) {};
    \node[anchor=west] at (0.25, 3.55) {Quality 0.8 < q \leq 0.9};

    \node[circle, fill=c3, inner sep=1.7pt] at (0.22, 3.45) {};
    \node[anchor=west] at (0.25, 3.45) {Quality 0.7 < q \leq 0.8};

    \node[circle, fill=c4, inner sep=1.4pt] at (0.22, 3.35) {};
    \node[anchor=west] at (0.25, 3.35) {Quality 0.6 q \leq 0.6 };
    ...
    \node at (2.51,4.1) {\footnotesize{\cite{McAnally2023}}};
    \node at (3.59,1.1) {\footnotesize{\cite{Mohanty2023}}};
    \node at (3.29,2.2) {\footnotesize{\cite{Morris2007}}};
    ...
    \node at (2.63,4.1) {\footnotesize{\cite{Vasudevan2020}}};
    \node at (3.71,1.9) {\footnotesize{\cite{Wall2000}}};
    \node at (2.31,3.1) {\footnotesize{\cite{Xia2023}}};

    % Add connecting lines wherever necessary
    \draw [very thin, gray](3.29,2.16) -- (3.29,2.03) node[anchor=north] {};  
