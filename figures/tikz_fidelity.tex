\begin{tikzpicture}[scale=3.6]
    ...
    \node[anchor=west] at (0.21, 1.65) {\scriptsize{Confidence $q > 0.9$}};

    \node[diamond, fill=c2, inner sep=1.3pt] at (0.18, 1.55) {};
    \node[anchor=west] at (0.21, 1.55) {\scriptsize{Confidence $0.8 < q \leq 0.9$}};

    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.7pt] at (0.18, 1.45) {};
    \node[anchor=west] at (0.21, 1.45) {\scriptsize{Confidence $0.7 < q \leq 0.8$}};

    \node[rectangle, fill=c4, inner sep=1.7pt] at (0.18, 1.35) {};
    \node[anchor=west] at (0.21, 1.35) {\scriptsize{Confidence $q \leq 0.7$}};
    ...
    \node[diamond, fill=c2, inner sep=1.3pt] at (3.46,0.5) {};
    \node[diamond, fill=c2, inner sep=1.3pt] at (3.46,0.5) {};
    \node[diamond, fill=c2, inner sep=1.3pt] at (3.46,0.5) {};
