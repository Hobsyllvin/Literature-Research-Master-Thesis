\begin{tikzpicture}[scale=3.6]
    ...
    % Add axis labels
    \draw[thick,<->] (0,1) -- (4,1) node[anchor=south west] {Haptic Fidelity};
    ...
    % Legend
    \draw[fill=white] (0.1,1.95) rectangle (1.05,1.2); % Legend border
    \node[anchor=west] at (0.13, 1.85) {\textbf{Legend}}; % Legend title
    
    \node[circle, fill=c1, inner sep=1.7pt] at (0.2, 1.7) {};
    \node[anchor=west] at (0.25, 1.7) {\scriptsize{Motor learning ++}};

    \node[diamond, fill=c2, inner sep=1.5pt] at (0.2, 1.6) {};
    \node[anchor=west] at (0.25, 1.6) {\scriptsize{Motor learning +}};

    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (0.2, 1.5) {};
    \node[anchor=west] at (0.25, 1.5) {\scriptsize{Motor learning o}};

    \node[rectangle, fill=c4, inner sep=1.7pt] at (0.2, 1.4) {};
    \node[anchor=west] at (0.25, 1.4) {\scriptsize{Motor learning -}};

    \node[star, star points=5, star point ratio=0.6, fill=c5, inner sep=1.6pt] at (0.2, 1.3) {};
    \node[anchor=west] at (0.25, 1.3) {\footnotesize{Motor learning - -}};
    ...
    \node[circle, fill=c1, inner sep=1.7pt] at (3.46,0.5) {};
    ...
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.5,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.22,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.8,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.46,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.46,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.34,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.63,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.75,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.21,0) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.25,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (4,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.88,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.84,1.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.7,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.71,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (4,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.57,2) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.59,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.28,0.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.42,1.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.72,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.5,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.49,1.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.61,0) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.57,2) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (3.71,1) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.31,1.5) {};
    \node[diamond, fill=c2, inner sep=1.5pt] at (2.84,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (2.2,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (0.63,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (3.38,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (3.75,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (1.39,1) {};
    \node[regular polygon, regular polygon sides=5, fill=c3, inner sep=1.5pt] at (2.76,0.5) {};
    \node[rectangle, fill=c4, inner sep=1.7pt] at (1.25,1.5) {};
    ...
    \node at (3.21,0.6) {\footnotesize{\cite{Dai2023}}};
    ...
    \node at (3.39,0.4) {\footnotesize{\cite{Fehlberg2012}}};
    \node at (3.51,0.4) {\footnotesize{\cite{Fehlberg2012}}};
    \node at (3.46,0.6) {\footnotesize{\cite{Fehlberg2012}}};
