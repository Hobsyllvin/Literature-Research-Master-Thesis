...
For example, in the experiment conducted by \cite{Lee2012} the participants were taught a drumming task by providing haptic feedback through vibrations on the drumstick itself. This kind of feedback guides the participant towards when to hit the drum, thus classifying as haptic augmented feedback. Another example is the experiment by \cite{Hanashima2023}, in which participants had to learn postures through vibrational feedback once they deviated from the intended posture. As this feedback guided participants towards the desired motion, it classifies as haptic augmented feedback.
