...
\onecolumn
\begin{table}[]
\begin{tabular}{@{}p{0.17\textwidth}p{0.17\textwidth}p{0.17\textwidth}p{0.19\textwidth}p{0.2\textwidth}@{}}
\toprule
 Feedback Fidelity & Reference & Experimental Design & ??? & Findings \\ \midrule
 Low & \cite{Huang2007VisualManipulation} &  &  &  \\
 Mid &  &  &  &  \\
 High & \cite{Huang2007VisualManipulation} & Turn rotary handle with resonance frequency of the system &  &  \\ \bottomrule
\end{tabular}
\end{table}
