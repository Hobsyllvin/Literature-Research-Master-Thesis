...
\newcommand\subparagraph{\@startsection{subparagraph}{5}{\z@}%
  ...
  {0.5ex \@plus .2ex}%
  {\normalfont\normalsize\bfseries}}
  \renewcommand{\@makefnmark}{\textcolor{blue}{\scalebox{0.7}{\textsuperscript{\@thefnmark}}}}
